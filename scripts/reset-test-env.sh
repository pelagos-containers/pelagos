...
nft delete table inet pelagos 2>/dev/null && echo "  deleted nft table" || echo "  (no nft table)"
nft delete table ip pelagos 2>/dev/null && echo "  deleted nft ip table" || true
