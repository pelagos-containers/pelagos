...
Measurements from `scripts/bench-coldstart.sh` — `remora run --rm alpine /bin/true`.
...
- **Binary:** remora 0.1.0
- **Runs:** 20 (warmup: 3)
- **Command:** `remora run --rm alpine /bin/true`
- **Result:** 3.3 ms  (mean 3.3 ms, stddev 0.6 ms, min 2.5 ms, max 4.3 ms)

| Command | Mean [ms] | Min [ms] | Max [ms] | Relative |
|:---|---:|---:|---:|---:|
| `/home/cb/Projects/remora/scripts/../target/release/remora run --rm alpine /bin/true` | 3.3 ± 0.6 | 2.5 | 4.3 | 1.00 |
